...
from digitalshadow.underwater_sim.discrete_hydromate_single import run_discrete_hydromate_single
...
TX_Coordinates = generate_grid_of_samples(Center[0],Center[1],10,500,2)
