...
def build_map(floaters_coordinates, TX_positions_coordinates, estimated_vessel_coordinates, output_file, track_TX=False, track_estimated=False):
    """
